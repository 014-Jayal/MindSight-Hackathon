...
if "🏠" in app_mode:
    ...
    with col1:
        st.markdown(create_feature_card(
            "AI Companion", 
            "Chat with your personal AI wellness companion for support and guidance",
            "💬",
            "Start Chat"
        ), unsafe_allow_html=True)
    ...
    with col2:
        st.markdown(create_feature_card(
            "Journal Entry", 
            "Write and analyze your daily thoughts with AI-powered sentiment analysis",
            "📝",
            "Write Entry"
        ), unsafe_allow_html=True)
    ...
    with col3:
        st.markdown(create_feature_card(
            "Mindfulness", 
            "Practice guided breathing exercises and meditation techniques",
            "🧘",
            "Start Session"
        ), unsafe_allow_html=True)
